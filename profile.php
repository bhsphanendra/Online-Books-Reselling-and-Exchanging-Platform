...
<body>
 ...
 <header class="header">
        ...
        <div class="user-actions">
            <div class="welcome-text">Welcome, <?= htmlspecialchars($user['firstname'] . ' ' . $user['lastname']) ?></div>
    ...
    <!-- Navigation Bar -->
    <nav class="navbar">
        <button class="nav-btn" onclick="location.href='<?php echo ($_SESSION['role'] === 'seller') ? 'seller.php' : 'user.php'; ?>'">
    ...
    <div class="profile-card">
        ...
        <div class="user-details">
            ...
            <div class="detail">
                ...
                <span class="value"><?= htmlspecialchars($user['lastname']) ?></span>
            </div>
            <div class="detail">
            ...
            <div class="detail">
                ...
                <span class="value"><?= htmlspecialchars($user['dob']) ?></span>
            </div>
            <div class="detail">
        ...
        <button class="edit-btn" type="button" onclick="location.href='edit_profile.php'">Edit Profile</button>
    </div>
</body>
</html>
